    ...
    return [
      {
        ...
        avatar: 'SL',
        text: 'TOUTSOP étais un étudiant exceptionnel qui s\'est démarqué par ses compétences techniques avancées et sa rigueur dans les projets. Sa capacité à analyser des problèmes complexes et à proposer des solutions innovantes est remarquable.',
        rating: 5
      },
      {
        name: 'FOTSO Simplice',
